...
<head>
    ...
    <title>@yield('title', 'Teacher Portal') - SMS</title>
            ...
            <div class="col-md-3 col-lg-2 px-0">
                <div class="sidebar p-3">
                    ...
                    <nav class="nav flex-column">
                        ...
                        <a class="nav-link {{ request()->routeIs('teacher.attendance.*') ? 'active' : '' }}" href="{{ route('teacher.classes') }}">
                            <i class="fas fa-calendar-check me-2"></i> Attendance
                        </a>
                        <a class="nav-link {{ request()->routeIs('teacher.exams.*') ? 'active' : '' }}" href="{{ route('teacher.classes') }}">
                            <i class="fas fa-file-alt me-2"></i> Exams
                        </a>
                        <a class="nav-link {{ request()->routeIs('teacher.results.*') ? 'active' : '' }}" href="{{ route('teacher.classes') }}">
